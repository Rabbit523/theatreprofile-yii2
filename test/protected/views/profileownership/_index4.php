<li>
	...
	<div class="media-body">
		<div class="media-heading">
			...
			<?php
				echo " <a class='btn' rel='tooltip' data-placement='right' title='View profile statistics.' href='".yii::app()->createUrl('/venue/analytics',array('id'=>$data->venue->id))."'><i class='icon-info-sign icon-red'></i></a>";	
			?>
		</div>
	</div>
</li>