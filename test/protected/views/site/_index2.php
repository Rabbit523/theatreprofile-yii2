		...
		<div class="media-body">
			<div class="media-heading">
				...
				<a href="<?php echo $data->production->createUrl(); ?>">
					<?php echo $data->production->show->showName.' - '.(!empty($data->production->productionName)?$data->production->productionName:$venueInfo).'<br />('.$data->production->startDate.' - '.$data->production->endDate.')'; ?>
				</a>
			</div>
		</div>
	</div>
