...
/**
 * This is the model class for table "tbl_venuewatchlist".
 *
 * The followings are the available columns in table 'tbl_venuewatchlist':
 * @property integer $id
 ...
 */
class Venuewatchlist extends CActiveRecord
{
	/**
	 ...
	 * @return Venuewatchlist the static model class
	 */
