...
/**
 * This is the model class for table "tbl_productionwatchlist".
 *
 * The followings are the available columns in table 'tbl_productionwatchlist':
 * @property integer $id
 ...
 */
class Productionwatchlist extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_productionwatchlist';
	}
	...
	public function rules()
	{
		...
		return array(
			array('userID, productionID', 'required'),
			array('userID, productionID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userID, productionID', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Productionwatchlist the static model class
	 */
