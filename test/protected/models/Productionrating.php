...
/**
 * This is the model class for table "tbl_productionrating".
 *
 * The followings are the available columns in table 'tbl_productionrating':
 * @property integer $id
 ...
 * @property User $user
 */
class Productionrating extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('userID, productionID, rating', 'required'),
			array('userID, productionID', 'numerical', 'integerOnly'=>true),
			array('rating', 'numerical'),
			array('rating', 'length', 'max'=>3),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userID, productionID, rating', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Productionrating the static model class
	 */
