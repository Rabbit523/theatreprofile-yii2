...
/**
 * This is the model class for table "tbl_companywatchlist".
 *
 * The followings are the available columns in table 'tbl_companywatchlist':
 * @property integer $id
 ...
 */
class Companywatchlist extends CActiveRecord
{
	/**
	 ...
	 * @return Companywatchlist the static model class
	 */
