...
class WatchlistController extends Controller
{
	...
	{	
		...
		$dataProvider1 = new CActiveDataProvider('Showwatchlist',array('criteria'=>$criteria1,'pagination'=>array('pageSize'=>20,)));		
		...
		$dataProvider2 = new CActiveDataProvider('Productionwatchlist',array('criteria'=>$criteria2,'pagination'=>array('pageSize'=>20,)));
		...
		$dataProvider3 = new CActiveDataProvider('Individualwatchlist',array('criteria'=>$criteria3,'pagination'=>array('pageSize'=>20,)));
		...
		$dataProvider4 = new CActiveDataProvider('Venuewatchlist',array('criteria'=>$criteria4,'pagination'=>array('pageSize'=>20,)));
		...
		$dataProvider5 = new CActiveDataProvider('Companywatchlist',array('criteria'=>$criteria5,'pagination'=>array('pageSize'=>20,)));
