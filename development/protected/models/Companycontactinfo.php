...
/**
 * This is the model class for table "tbl_companycontactinfo".
 *
 * The followings are the available columns in table 'tbl_companycontactinfo':
 * @property string $id
 ...
 */
class Companycontactinfo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('companyID, contactTypeID', 'required'),
			array('companyID, contactTypeID', 'numerical', 'integerOnly'=>true),
			array('contactInfo', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, companyID, contactTypeID, contactInfo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Companycontactinfo the static model class
	 */
