...
/**
 * This is the model class for table "tbl_individualcontactinfo".
 *
 * The followings are the available columns in table 'tbl_individualcontactinfo':
 * @property string $id
 ...
 */
class Individualcontactinfo extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_individualcontactinfo';
	}
	...
	public function rules()
	{
		...
		return array(
			array('individualID, contactTypeID', 'required'),
			array('individualID, contactTypeID', 'numerical', 'integerOnly'=>true),
			array('contactInfo', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, individualID, contactTypeID, contactInfo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Individualcontactinfo the static model class
	 */
