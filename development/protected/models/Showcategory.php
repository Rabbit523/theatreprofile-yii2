...
/**
 * This is the model class for table "tbl_showcategory".
 *
 * The followings are the available columns in table 'tbl_showcategory':
 * @property integer $id
 ...
 * @property Show[] $shows
 */
class Showcategory extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'shows' => array(self::HAS_MANY, 'Show', 'categoryID'),
		);
	}
	 ...
	 * @return Showcategory the static model class
	 */
