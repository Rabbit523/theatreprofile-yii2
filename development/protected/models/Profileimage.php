...
/**
 * This is the model class for table "tbl_profileimage".
 *
 * The followings are the available columns in table 'tbl_profileimage':
 * @property integer $id
 ...
 */
class Profileimage extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('profileID, profileType, imageID, imageType', 'required'),
			array('profileID, profileType, imageID, imageType', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, profileID, profileType, imageID, imageType', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Profileimage the static model class
	 */
