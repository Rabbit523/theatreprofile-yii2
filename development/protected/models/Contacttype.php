...
/**
 * This is the model class for table "tbl_contacttype".
 *
 * The followings are the available columns in table 'tbl_contacttype':
 * @property integer $id
 * @property string $descr
 *
 * The followings are the available model relations:
 * @property Showcontactinfo[] $showcontactinfos
 */
class Contacttype extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'showcontactinfos' => array(self::HAS_MANY, 'Showcontactinfo', 'contactTypeID'),
		);
	}
