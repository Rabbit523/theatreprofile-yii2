...
<body itemscope itemtype="http://schema.org/WebSite">
		...
		'items'=>array(
			...
			array(
				...
				'items'=>array(
					...
					array('label'=>'About', 'url'=> 'https://www.theatreprofile.info/'),
					array('label'=>'FAQ', 'url'=>'https://theatre-profile.wixanswers.com/'),
	...
	<div id="footer">
			...
			<?php endif; ?>
			<a href="<?php echo yii::app()->createUrl('terms'); ?>">Terms of use</a> | <a href="<?php echo yii::app()->createUrl('privacy'); ?>">Privacy Policy</a> | <a href="<?php echo yii::app()->createUrl('contact'); ?>">Contact us</a> | <a href="https://www.theatreprofile.info/" target="_blank">Learn more</a> | <a href="<?php echo yii::app()->createUrl('grow'); ?>">Grow with us</a> | <a href="https://confirmsubscription.com/h/d/37A6B58F80965DBD" target="_blank">Join The Newsletter</a> | <a href="mailto:info@theatreprofile.com">Report a problem</a>
			<br /><br />
