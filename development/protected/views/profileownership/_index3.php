<li>
	...
	<div class="media-body">
		<div class="media-heading">
			...
			<?php
				echo " <a class='btn' rel='tooltip' data-placement='right' title='View profile statistics.' href='".yii::app()->createUrl('/people/analytics',array('id'=>$data->individual->id))."'><i class='icon-info-sign icon-red'></i></a>";	
			?>
		</div>
	</div>
</li>