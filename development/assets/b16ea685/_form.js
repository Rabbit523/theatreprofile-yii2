				...
				return function(e) {
					...
					image.onload = function() {           
						if (image.width > 1280 || image.height > 1024) {
							$(".img-upload.alert.alert-error").html("Some images were too large and could not be processed.").show();
						} else {
