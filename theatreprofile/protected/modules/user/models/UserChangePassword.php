...
class UserChangePassword extends CFormModel {
	...
	public function rules() {
		return Yii::app()->controller->id == 'recovery' ? array(
			...
			array('password, verifyPassword', 'length', 'max'=>128, 'min' => 4,'message' => UserModule::t("Incorrect password (minimum length 4 characters).")),
			...
			array('oldPassword, password, verifyPassword', 'length', 'max'=>128, 'min' => 4,'message' => UserModule::t("Incorrect password (minimum length 4 characters).")),
			array('verifyPassword', 'compare', 'compareAttribute'=>'password', 'message' => UserModule::t("Passwords do not match.")),
