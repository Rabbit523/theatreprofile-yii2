...
class RegistrationForm extends User {
	...
	public function rules() {
		$rules = array(
			...
			array('username', 'length', 'max'=>20, 'min' => 3,'message' => UserModule::t("Invalid user name or email address (length between 3 and 20 characters).")),
			array('password', 'length', 'max'=>128, 'min' => 4,'message' => UserModule::t("Invalid password (minimum length 4 characters).")),
			array('email', 'email'),
