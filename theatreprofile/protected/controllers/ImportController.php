...
class ImportController extends Controller
{
	...
	{
		return 'importdata,transformdata';
	}
	...
	public function actionTransformData($key)
    {
		if($key=='KsJyg9APMwaCZxEKcg')
		{
			$command = Yii::app()->db->createCommand('CALL importtttcvenue()');
			$command->execute();
			$command = Yii::app()->db->createCommand('CALL importTTTCTicketSale()');
			$command->execute();
		}
		else
		{
