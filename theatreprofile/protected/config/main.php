...
return array(
	...
	'modules'=>array(
		...
		'gii'=>array(
			...
			'ipFilters'=>array('127.0.0.1','::1','37.61.233.186'),
		...
		'audit' => array(
            ...
            'adminUsers' => array('admin','g3kelly','Fern'),
	...
	'clientScript'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
                ...
                array('api/users', 'pattern'=>'api/getUsers/get/', 'verb'=>'GET'),
                array('api/userValidCheck', 'pattern' => 'api/<model:\w+>/userValidCheck/<userID:\d+>/<ipAddress:\w+>/<activeKey:\w+>', 'verb'=>'GET'),
	...
	'params'=>array(
		...
		'mediaServeUrl'=>'https://media.theatreprofile.com',
