...
/**
 * This is the model class for table "tbl_productioncontactinfo".
 *
 * The followings are the available columns in table 'tbl_productioncontactinfo':
 * @property string $id
 ...
 */
class Productioncontactinfo extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_productioncontactinfo';
	}
	...
	public function rules()
	{
		...
		return array(
			array('productionID, contactTypeID', 'required'),
			array('productionID, contactTypeID', 'numerical', 'integerOnly'=>true),
			array('contactInfo', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, productionID, contactTypeID, contactInfo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Productioncontactinfo the static model class
	 */
