...
/**
 * This is the model class for table "tbl_productioncategory".
 *
 * The followings are the available columns in table 'tbl_productioncategory':
 * @property integer $id
 * @property string $categoryName
 */
class Productioncategory extends CActiveRecord
{
	/**
	 ...
	 * @return Productioncategory the static model class
	 */
