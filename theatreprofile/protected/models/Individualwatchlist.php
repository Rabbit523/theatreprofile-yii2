...
/**
 * This is the model class for table "tbl_individualwatchlist".
 *
 * The followings are the available columns in table 'tbl_individualwatchlist':
 * @property integer $id
 ...
 */
class Individualwatchlist extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_individualwatchlist';
	}
	 ...
	 * @return Individualwatchlist the static model class
	 */
