...
/**
 * This is the model class for table "tbl_showwatchlist".
 *
 * The followings are the available columns in table 'tbl_showwatchlist':
 * @property integer $id
 ...
 * @property Show $show
 */
class Showwatchlist extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('userID, showID', 'required'),
			array('userID, showID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userID, showID', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Showwatchlist the static model class
	 */
