...
/**
 * This is the model class for table "tbl_venuecontactinfo".
 *
 * The followings are the available columns in table 'tbl_venuecontactinfo':
 * @property string $id
 ...
 */
class Venuecontactinfo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('venueID, contactTypeID', 'required'),
			array('venueID, contactTypeID', 'numerical', 'integerOnly'=>true),
			array('contactInfo', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, venueID, contactTypeID, contactInfo', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Venuecontactinfo the static model class
	 */
