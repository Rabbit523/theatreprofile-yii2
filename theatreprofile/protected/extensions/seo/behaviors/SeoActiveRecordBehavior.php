...
class SeoActiveRecordBehavior extends CActiveRecordBehavior
{
    ...
    {
        return Yii::app()->createUrl($this->route, CMap::mergeArray($params, $this->evaluateParams($this->params,false)));
    }
    ...
    {
        return Yii::app()->createAbsoluteUrl($this->route, CMap::mergeArray($params, $this->evaluateParams($this->params,false)));
    }
     ...
     */
    protected function evaluateParams($params,$isCallableCheck=true)
    {
