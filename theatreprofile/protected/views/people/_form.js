...
function cast_adder()
{
	...
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><label>Show <span class="required">*</span></label><input id="showName_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][showName]" required="required"rel="tooltip" data-placement="right" data-title="Input a minimum of 3 characters to receive suggestions" autocomplete="off"/><label>Production <span class="required">*</span></label><select id="productionID_'+random_hash_name+'" type="hidden" name="cast[new]['+cfg.cast_counter+'][productionID]"><option value="0">Select</option></select><label>Role Name</label><input type="text" name="cast[new]['+cfg.cast_counter+'][roleName]"  maxlength="100"><label>Start date</label><input id="cast_start_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][startDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right"><label>End date</label><input id="cast_end_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][endDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right"><input id="showID_'+random_hash_name+'" type="hidden" name="cast[new]['+cfg.cast_counter+'][showID]" value="0" /></div>';
	cfg.cast_counter++;
...
function crew_adder()
{
	...
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><label>Show <span class="required">*</span></label><input id="showName_'+random_hash_name+'" type="text" name="crew[new]['+cfg.crew_counter+'][showName]" required="required" rel="tooltip" data-placement="right" data-title="Input a minimum of 3 characters to receive suggestions" autocomplete="off"/><label>Production <span class="required">*</span></label><select id="productionID_'+random_hash_name+'" type="hidden" name="crew[new]['+cfg.crew_counter+'][productionID]"><option value="0">Select</option></select><label>Role <span class="required">*</span></label><input id="roleName_'+random_hash_name+'" type="text" autocomplete="off" name="crew[new]['+cfg.crew_counter+'][roleName]" required="required" maxlength="100" rel="tooltip" data-placement="right" data-title="Input a minimum of 3 characters to receive suggestions" autocomplete="off" /><label>Start date</label><input id="crew_start_'+random_hash_name+'" type="text" name="crew[new]['+cfg.crew_counter+'][startDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><label>End date</label><input id="crew_end_'+random_hash_name+'" type="text" name="crew[new]['+cfg.crew_counter+'][endDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><input id="showID_'+random_hash_name+'" type="hidden" name="crew[new]['+cfg.crew_counter+'][showID]" value="0" /><input id="roleID_'+random_hash_name+'" type="hidden" name="crew[new]['+cfg.crew_counter+'][roleID]" value="0" ></div>';
	cfg.crew_counter++;
...
function creator_adder()
{
	...
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><label>Enter show name <span class="required">*</span></label><input id="tb_'+random_hash_name+'" type="text" name="creator[new]['+cfg.counter_counter+'][showName]" required="required" rel="tooltip" data-placement="right" data-title="Input a minimum of 3 characters to receive suggestions" autocomplete="off"/><label>Role <span class="required">*</span></label>'+role+'<input id="showID_'+random_hash_name+'" type="hidden" name="creator[new]['+cfg.counter_counter+'][showID]" value="0" /></div>';
	cfg.counter_counter++;
