...
$( "#Production_firstPreviewDate" ).datepicker({dateFormat:"mm-dd-yy", changeMonth:true, changeYear:true});
$( "#Production_startDate" ).datepicker({dateFormat:"mm-dd-yy", changeMonth:true, changeYear:true});
$( "#Production_endDate" ).datepicker({dateFormat:"mm-dd-yy", changeMonth:true, changeYear:true});
...
{
	var random_hash_name='field_'+Math.floor((Math.random() * 10000) + 1);
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><label>Enter Venue Name <span class="required">*</span></label><input id="tb_'+random_hash_name+'" type="text" name="venue[new]['+cfg.venue_counter+'][venueName]" required="required" autocomplete="off" rel="tooltip" data-placement="right" data-title="Enter venue name only; Input a minimum of 3 characters to receive suggestions" /><label>Start date</label><input id="venue_start_'+random_hash_name+'" type="text" name="venue[new]['+cfg.venue_counter+'][startDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><span class="help-block">Leave empty to use production start date.</span><label>End date</label><input id="venue_end_'+random_hash_name+'" type="text" name="venue[new]['+cfg.venue_counter+'][endDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><span class="help-block">Leave empty to use production end date.</span><input id="venueID_'+random_hash_name+'" type="hidden" name="venue[new]['+cfg.venue_counter+'][venueID]" value="0" ></div>';
	cfg.venue_counter++;
	$('#venue_container').prepend(html);
	$( "#venue_start_"+random_hash_name ).datepicker({dateFormat:"mm-dd-yy", changeMonth:true, changeYear:true});
	$( "#venue_end_"+random_hash_name ).datepicker({dateFormat:"mm-dd-yy", changeMonth:true, changeYear:true});
...
{
	var random_hash_name='field_'+Math.floor((Math.random() * 10000) + 1);
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><label>Enter Cast Name <span class="required">*</span></label><input id="tb_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][castName]" required="required" data-autocomplete="individual" autocomplete="off" rel="tooltip" data-title="Format: First Middle Last Suffix; Input a minimum of 3 characters to receive suggestions" data-placement="right"><label>Role Name</label><input id="cast_roleName_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][roleName]" maxlength="100"><label>Start date</label><input id="cast_start_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][startDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><label>End Date</label><input id="cast_end_'+random_hash_name+'" type="text" name="cast[new]['+cfg.cast_counter+'][endDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><input id="individualID_'+random_hash_name+'" type="hidden" name="cast[new]['+cfg.cast_counter+'][individualID]" value="0" /></div>';
	cfg.cast_counter++;
...
function crew_adder()
{
	...
	var html='<div class="well" id="'+random_hash_name+'"><a class="ui-icon ui-icon-close pull-right" onclick="$(this).parent().remove();"></a><strong><label class="radio inline"><input type="radio" class="crewType" name="crew[new]['+cfg.crew_counter+'][crewType]" id="crewType1_'+random_hash_name+'" value="1" checked>Individual</label><label class="radio inline"><input type="radio" class="crewType" name="crew[new]['+cfg.crew_counter+'][crewType]" id="crewType2_'+random_hash_name+'" value="2">Company</label><label>Enter Crew Name <span class="required">*</span></label><input data-autocomplete="individual" type="text" name="crew[new]['+cfg.crew_counter+'][crewName]" required="required" autocomplete="off" rel="tooltip" data-title="Format: First Middle Last Suffix; Input a minimum of 3 characters to receive suggestions" data-placement="right"><label>Role <span class="required">*</span></label><input id="tbrole_'+random_hash_name+'" type="text" autocomplete="off" name="crew[new]['+cfg.crew_counter+'][roleName]" required="required"  maxlength="100" rel="tooltip" data-placement="right" data-title="Input a minimum of 3 characters to receive suggestions" /><label>Start Date</label><input id="crew_start_'+random_hash_name+'" type="text" name="crew[new]['+cfg.crew_counter+'][startDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right"><label>End Date</label><input id="crew_end_'+random_hash_name+'" type="text" name="crew[new]['+cfg.crew_counter+'][endDate]" rel="tooltip" data-title="MM-DD-YYYY" data-placement="right" /><input id="individualID_'+random_hash_name+'" type="hidden" name="crew[new]['+cfg.crew_counter+'][profileID]" value="0" /><input id="crew_roleID_'+random_hash_name+'" type="hidden" name="crew[new]['+cfg.crew_counter+'][roleID]" value="0" /></strong></div>';
	cfg.crew_counter++;
